...
### 1. 项目准备：⾸先，确保你已经安装了 Axios，如果使用npm，可以npm install axios
### 2. 封装Axios
...
```
### 4. CMD 规范（Common Module Definition）
